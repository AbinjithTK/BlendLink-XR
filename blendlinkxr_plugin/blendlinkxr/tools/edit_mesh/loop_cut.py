...
from blendlinkxr.utils import make_bmesh_copy, get_bmesh_copy, revert_to_bmesh_copy, free_bmesh_copy, get_bvh_copy, log
...
def on_controller_move(self, event_name, event):
    ...
    bm = get_bmesh()  # get it again, to rebuild indices, if necessary
