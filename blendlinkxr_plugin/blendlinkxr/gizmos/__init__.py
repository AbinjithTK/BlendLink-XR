...
MODULES = {  # gizmo_name -> modules
    ...
    "auto_record_events": "auto_record_events",
    "track_xr_device_empties": "track_xr_device_empties",
    "text_editor_ux_improvements": "text_editor_ux_improvements",
    "cable_manager": "cable_manager",
    "mx_ink_pen_model": "mx_ink_pen_model",
