...
from blendlinkxr.utils import get_blendlink_collection
...
def get_mirror_object():
    coll = get_blendlink_collection()
    if "blendlinkxr_mirror_global" in coll.objects:
        return coll.objects["blendlinkxr_mirror_global"]

    mirror_mesh_data = bpy.data.meshes.new("blendlinkxr_mirror_mesh_data")
    mirror_obj_global = bpy.data.objects.new("blendlinkxr_mirror_global", mirror_mesh_data)
    coll.objects.link(mirror_obj_global)

    return mirror_obj_global
