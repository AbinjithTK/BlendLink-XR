...
from blendlinkxr.settings_manager import save_settings_to_file

from mathutils import Vector

RIGHT_HANDED_POSITION = Vector((-1.48, -1.1, 0))
LEFT_HANDED_POSITION = Vector((0.48, -1.1, 0))
...
def on_close_press(self, event_name, event):
    ...
    settings["view.show_info_panel"] = False
...
info_msg.style["visible"] = settings["view.show_info_panel"]
...
def enable():
    # Info panel disabled — no external promotions in BlendLink XR
    pass
