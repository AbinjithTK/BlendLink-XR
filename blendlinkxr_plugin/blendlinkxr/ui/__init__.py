...
def enable_xr_ui():
    ...
    # hack to workaround the inability to create Image elements on main menu clicks
    # enable_gizmo("desktop_viewer")
    # disable_gizmo("desktop_viewer")
