...
actions = [
    ...
    # --- MX Ink exclusive actions (right hand only) ---
    Action("mx_ink_dock_state", binding_name="MX_INK_DOCK_STATE", user_paths=["/user/hand/right"]),
    Action("mx_ink_front_double_tap", binding_name="MX_INK_FRONT_DOUBLE_TAP", user_paths=["/user/hand/right"]),
    Action("mx_ink_back_double_tap", binding_name="MX_INK_BACK_DOUBLE_TAP", user_paths=["/user/hand/right"]),
    Action("mx_ink_tip_force", binding_name="MX_INK_TIP_FORCE", user_paths=["/user/hand/right"]),
]
